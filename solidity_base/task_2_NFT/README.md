...
## 通过pinata服务商，上传两个文件到IPFS上
 - image_uri https://ipfs.io/ipfs/bafkreidhrk2tyeeuaavkrnfu3mvac4xoja2hba752oep4rcbawgusx7noi
 - meta_uri https://ipfs.io/ipfs/bafkreiehhfrqf63gkbsw43wf4n7rhrvolyofpsjfuooli54lq7rxk5o2pi

```
metadata.json文件
{
  "description": "wu song da hu", 
  "image": "https://ipfs.io/ipfs/bafkreidhrk2tyeeuaavkrnfu3mvac4xoja2hba752oep4rcbawgusx7noi", 
  "name": "WSDH"
}

metadata.json文件中image 填入该图片uri。然后生产meta_uri，这个地址就可以作为铸造地址了

铸币合约地址：0xeD51cDAc601ac9D43C6fe521f5d5709A71D8916A
```
